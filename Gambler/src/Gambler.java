...
public class Gambler {
    ...
    public static void main(String[] args) {
         ...
         *  used for loop to play for 12 months but if loss happens stop game
         ...
         *  used while  loop to play game till gambler win or loose 50% of Stack
         *  In while loop,
         ...
         *  printing luckiest and unluckiest day of that month
        ...
        for (int month = 1; month <= 12; month++) {
            ...
            System.out.println("\n *** Month " + month + " Details ***");
            System.out.println(" Luckiest day is Day " + maxWin + "\n Unluckiest day is Day " + maxLoose);
